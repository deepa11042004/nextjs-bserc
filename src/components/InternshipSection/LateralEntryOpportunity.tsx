...
const LateralStatCard: React.FC<StatCardProps> = ({ value, label }) => (
  <div className="rounded-lg border border-white/10 bg-gray-900/50 p-5 text-center flex flex-col justify-center h-full">
    <p className="text-3xl sm:text-4xl font-extrabold text-amber-400 mb-1">{value}</p>
    <p className="text-gray-400 text-sm tracking-wide">{label}</p>
  </div>
);

const LateralEntryOpportunity: React.FC = () => {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="rounded-xl border border-white/10 bg-gray-800/50 p-6 sm:p-8 mb-6">
          ...
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
            Bharat Space Education Research Centre is pleased to announce an opportunity for Officials, Faculty, Research Scholars, and Students to engage in lateral entry into their preferred technology areas. This initiative does not involve an examination process.
          </p>
        </div>

        {/* Middle Grid: Who Can Apply & Benefits */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="rounded-xl border border-white/10 bg-gray-900/50 p-6 sm:p-8 h-full">
            ...
            <LateralListItem term="Government Officials" description="- Working in Defence & Space sectors" />
            <LateralListItem term="Faculty Members" description="- From educational institutions" />
            <LateralListItem term="Research Scholars" description="- Pursuing advanced studies" />
            <LateralListItem term="Working Professionals" description="- With relevant experience" />
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-gray-900/50 p-6 sm:p-8 h-full">
            ...
            <LateralListItem term="No Examination" description="- Direct registration process" />
            <LateralListItem term="Choose Your Domain" description="- Select preferred technology areas" />
            <LateralListItem term="Expert Mentorship" description="- Guidance from industry leaders" />
            <LateralListItem term="Certificate & Recognition" description="- Official credentials" />
          </div>
        </div>
...
export default LateralEntryOpportunity;