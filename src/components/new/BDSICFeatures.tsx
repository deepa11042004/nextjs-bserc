...
const BDSICFeatures: React.FC = () => {
  return (
    <section className="w-full py-12 sm:py-16 px-4 bg-black">
      <div className="max-w-6xl mx-auto">

        {/* Heading */}
        <h3 className="text-4xl md:text-4xl text-center font-bold font-serif text-white mb-6 leading-tightlg:text-4xl pb-10">
          Features of BDSIC 2026 - Online Technical Pool
        </h3>
