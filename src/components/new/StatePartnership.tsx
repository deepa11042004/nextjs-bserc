...
const StateCard = ({ state }: { state: State }) => {
  return (
    <div
      className={` rounded-xl p-6 text-center transition-all cursor-pointer border
      ${
        state.isUT
    ...
    >
      ...
      <h3 className="font-semibold text-white font-serif text-xm ">{state.name}</h3>
    ...
    <section className=" w-full py-12  px-4  bg-black  ">
      <div className="max-w-7xl mx-auto rounded-2xl px-6 py-16 bg-gradient-to-br from-[#1E90FF]/10 to-[#FF6B35]/10">
        ...
        <div className="text-center mb-12">
         ...
         <h2 className="text-4xl md:text-4xl text-center font-bold font-serif text-white mb-5 pt-5 leading-tightlg:text-4xl  ">
            State Governments Partnership
          </h2>
        ...
        {/* Grid */}
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-12 max-w-6xl mx-auto ">
          {states.map((state) => (
        ...
        <div className="rounded-2xl p-10 border border-white/10 bg-gradient-to-br from-[#1E90FF]/10 to-[#FF6B35]/10 max-w-6xl mx-auto">
          ...
          <h3 className="text-4xl md:text-4xl text-center font-bold font-serif text-white pt-5 mb-6 leading-tightlg:text-4xl  ">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 ">
            {[
              ...
              <div
                key={item.title}
                className="p-6 py-10 rounded-xl border border-white/10 bg-[#242424] text-cener hover:shadow-md transition "
              >
