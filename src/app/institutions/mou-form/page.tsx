...
export default function MoURequestPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.authorized_person_name.trim()) newErrors.authorized_person_name = "Authorized person is required";
    if (!formData.email.trim()) newErrors.email = "Email is required";
    if (!formData.purpose.trim()) newErrors.purpose = "Please describe your purpose";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Submit your proposal for a Memorandum of Understanding with BSERC.
          </p>
        </div>

        {/* Form Card */}
        <div className="bg-slate-900 rounded-2xl p-6 md:p-8 shadow-2xl border border-slate-800">
          <form onSubmit={handleSubmit} encType="multipart/form-data" noValidate className="space-y-2">
              ...
              <div className="mb-6 p-4 bg-green-900/20 border border-green-800 rounded-lg text-green-300 flex items-start gap-3 animate-in slide-in-from-top-2" role="alert">
                ...
                <div>
                  ...
                  <p className="text-green-400/90 text-sm mt-1">
                    Thank you! Your MoU request has been received. We'll contact you within 48 hours.
                  </p>
                </div>
              </div>
            )}
            ...
            {/* Row 1: Organization + Authorized Person */}
            ...
            <FormTextarea
              id="purpose"
              name="purpose"
              label="Purpose of MoU / Proposal"
              placeholder="Describe the purpose of this MoU, expected outcomes, and collaboration scope..."
              rows={5}
              required
            ...
            <div className="p-4 bg-blue-900/20 border border-blue-800 rounded-lg text-blue-300 text-sm flex items-start gap-3 mb-4">
              <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="text-center text-slate-500 text-sm mt-8">
          <svg className="w-4 h-4 inline-block mr-1 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
          Questions? Contact us at{" "}
          <a href="mailto:mou@bserc.org" className="text-blue-400 hover:text-blue-300 underline transition-colors">
            mou@bserc.org
          </a>
        </p>
      </div>
