  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="bg-gradient-to-r from-blue-700 to-indigo-700 text-center py-16 shadow-lg">
        ...
        <p className="mt-3 text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed">
         This workshop is designed to benefit Faculty, Research Scholars and Students by enhancing their understanding of aircraft design principles, aerodynamic fundamentals, performance analysis, and configuration layout through interactive sessions.
