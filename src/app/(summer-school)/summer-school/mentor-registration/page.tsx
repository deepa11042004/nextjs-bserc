...
"
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-[#0f1f2e] border border-[#1e3a4a] rounded-lg p-6 text-center hover:border-cyan-500/30 transition-colors">
          ...
          <p className="text-cyan-400 text-3xl font-bold mb-2">
            US$ 150
          </p>
          <p className="text-zinc-400 text-xs">
            One-time participation fee
      ...
      <div className="bg-[#111111] border border-[#262620] rounded-lg p-4">
        <p className="text-zinc-400 text-sm">
          <span className="text-cyan-400 font-semibold">What the fee includes:</span>{" "}
          <span className="text-zinc-500">
            Mentor onboarding & training, access to BSERC's digital mentorship platform, coordination support, certificate of mentorship, and year-round BSERC community engagement.
          </span>
        </p>
      </div>
    </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                After submission, your application will be reviewed by the BSERC team. Shortlisted candidates will receive an email with onboarding details, mentor handbook, platform access, and a formal Letter of Mentorship within 5–7 working days.
              </p>
            </div>
          </div>
        </div>
