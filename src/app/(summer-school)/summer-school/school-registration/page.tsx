    ...
    <div className="min-h-screen bg-[#0d0d0d] text-zinc-300 py-12 md:py-16 px-4 selection:bg-[#a4cc22] selection:text-black">
      <div className="max-w-5xl mx-auto">
        ...
        {showPayment && (
          <SectionCard
            id="payment-section"
            title="Annual Partnership Fee"
            subtitle="Become an official Def-Space Partner School"
          >
            <div className="bg-gradient-to-br from-[#111111] to-[#0f0f0f] border border-[#2a2a2a] rounded-xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="text-white font-semibold">
                    Def-Space Partner School
                  </h4>
                  <p className="text-zinc-400 text-sm">
                    Official institutional partnership status
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      "Official 'Def-Space Partner School' certification",
              ...
              <div className="bg-[#111111] rounded-lg p-4 border border-[#262620] mb-6">
                <p className="text-zinc-400 text-sm">
                  After submission of your school registration form, you will
                  receive a secure payment link via email. Multiple payment
                  methods accepted including bank transfer, card payments, and
                  digital wallets.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-8 py-3.5 rounded-full font-bold bg-orange-500 hover:bg-orange-500 text-black transition-all active:scale-95 shadow-lg shadow-[#ccf15a]/10"
                >
                  Proceed to Payment
                  <ArrowRight className="w-5 h-5" />
                </button>
                <div className="flex items-center gap-2 text-zinc-500 text-xs">
                  ...
                  <span>Secure • PCI-DSS Compliant • Encrypted</span>
                </div>
              </div>
            </div>
          </SectionCard>
