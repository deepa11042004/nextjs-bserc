  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-zinc-300 py-16 px-4 selection:bg-[#a4cc22] selection:text-black">
      <main className="max-w-4xl mx-auto">
        ...
        {/* 7. Previous Mentoring Experience */}
        ...
        <SectionCard title="8. OUR GUIDELINES / हमारी दिशानिर्देश">
          ...
          <div className="bg-[#111111] border border-[#2d3023] rounded-3xl p-8 mb-6">
            <div className="flex gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed text-sm max-w-5xl mx-auto">
                  ...
                  tenure, your mentor profile will be activated and made visible
                  to interns, students, startups, professionals, and companies.
                  {" "}
                </p>
              </div>
            </div>
